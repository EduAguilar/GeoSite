...
ListadoPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-listado',template:/*ion-inline-start:"/home/eduardo/Documentos/Proyecto Ing. Soft 2/misSitios/src/pages/listado/listado.html"*/'<!--\n  Generated template for the ListadoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Listado</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let sitio of sitios" (click)="muestraSitio(sitio)">\n      <ion-thumbnail item-left>\n        <img [src]="sitio.foto">\n      </ion-thumbnail>\n      <h2>{{ sitio.address }}</h2>\n      <p>{{ sitio.description }}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Proyecto Ing. Soft 2/misSitios/src/pages/listado/listado.html"*/,
    }),
